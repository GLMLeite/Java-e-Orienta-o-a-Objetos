...
public class Entrega{	
	...
	public static Funcionario cadastrar() {
		...
		System.out.println("Digite sua login funcionário");
		cadfunc.loginfunc = leitor.nextLine();
		System.out.println("Digite sua senha funcionário");
	...
	void entregas() {
        ...
        while(i=='s' || i=='S'){
        	...
        	System.out.println("Informe o código do produto a ser entregue ");
        ...
        i= 's';      
        while(i=='s' || i=='S'){
      	System.out.println("Informe os códigos dos produtos pendentes");
      	cdgproduto = leitor.nextLine();
        ...
        System.out.println("Códigos de pedidos pendentes : " + Pendentes);
        System.out.println("Códigos de pedidos pendentes : " + Entregues);    
	}
}
